  ...
  return (
    <section className="py-12 px-4 md:px-8 max-w-5xl mx-auto bg-white">
      ...
      <div className="mb-10">
        <Link
          href="/blog"
          className="text-blue-700 hover:underline text-sm mb-4 inline-flex items-center font-medium"
        >
          <svg
        ...
        <h2 className="text-xl md:text-2xl font-medium text-gray-800 mt-4">
          {blogPost.subtitle}
        </h2>
          ...
          <div className="sticky top-8 bg-gray-50 rounded-lg p-6 shadow-sm">
            ...
            <div className="mt-8">
              ...
              <div className="space-y-2">
                <Link
                  href="#"
                  className="block text-sm text-gray-700 hover:text-blue-700 transition-colors py-1"
                >
                  Real Estate News
                </Link>
                <Link
