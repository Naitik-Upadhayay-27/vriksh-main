...
export default function BlogList() {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-16 px-4 md:px-8 max-w-7xl mx-auto bg-white"
    >
          ...
          >
            <article className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 h-full flex flex-col border border-gray-200">
              ...
              <div className="p-5 md:p-6 flex-1 flex flex-col">
                ...
                <h3 className="text-xl font-semibold mb-3 text-gray-900 group-hover:text-gray-700 transition-colors line-clamp-2">
                  {post.title}
                </h3>
